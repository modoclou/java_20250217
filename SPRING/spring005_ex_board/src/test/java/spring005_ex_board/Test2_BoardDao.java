...
public class Test2_BoardDao {
	...
	public void test1() throws UnknownHostException {
		...
		//4. update
//		BoardDto dto = new BoardDto();s
//		dto.setBname("first");	dto.setBtitle("title");	dto.setBpass("1111");	dto.setBno(1);
//		dto.setBcontext("content");	dto.setBip(InetAddress.getLocalHost().getHostAddress());

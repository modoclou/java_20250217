...
public class Poly003 {
	public static void main(String[] args) {
		TestB3 tb = (TestB3) new TestA3(); //4. 자식 = 부모 / 다운캐스팅 / 타입캐스팅 필요 O!!
		//1. TestB3 tb 범위: TestB3 {int b / toString }-TestA3{int a / --------(Override, 이름/메서드가 같으면)}
		//2. TestA3()는 int a만 처리		X			   TestA3(){int a / toString}
		//3. TestB3 {int b / toString } 보장 안 됨.	B 영역은 누수로 고장났다..

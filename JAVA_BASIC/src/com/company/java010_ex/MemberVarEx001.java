...
class Sawon3{
	//상태(멤버변수)
    int pay      =10000;    //인스턴스변수 - heap - new관련O - this(각각생기니까관련있다), 생성자   
    static int su=10;		//클래스변수 - method영역과 관련 - new와 관련 X(메모리상에 먼저올라몸) - 공유하는 목적 
//  static int basicpay=pay; //클래스변수=인스턴스변수 (클래스변수, 클래스메서드 - this, 인스턴스 사용 불가)

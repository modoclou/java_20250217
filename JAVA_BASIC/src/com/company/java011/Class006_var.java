...
/***
------------------------------------------------------------------
[method: 정보, 공유 영역] A.class / Class006.class / company[], main   ##1.
------------------------------------------------------------------
[heap: 동적]                     | [stack: 임시]
...
* 					 기본값       명시적 초기화        초기화 블록         생성자
  클래스 변수 company  1. null    2.(주)동물농장     3.(주)동물농장-joy    X(무관함)
...
class A{
	//멤버변수
	int a=10; //* 인스턴스 변수 - heap - new 관련 O - this 각각
	{ a=100; }
	static String company="(주) 동물농장"; //명시적 초기화
	static{ company="(주) 동물농장-joy"; } //초기화 블록(빼면 명시적 초기화)
	//클래스 변수 - method - new, 생성자 관련 X - 공유 
	//멤버함수
